...
def set_ventana1(frame):
    VentanaCliente(root,frame)
...
if __name__ == '__main__':
    ...
    button = Button(frame,text='VentanaCliente',command=lambda: set_ventana1(frame))
    button.grid(row=1,column=1,sticky=W+E)
    button = Button(frame,text='VentanaCompra',command=lambda: set_ventana2(frame))
    button.grid(row=1,column=2,sticky=W+E)
    button = Button(frame,text='VentanaTrabajador',command=lambda: set_ventana3(frame))
    button.grid(row=1,column=3,sticky=W+E)
    button = Button(frame,text='VentanaProducto',command=lambda: set_ventana4(frame))
